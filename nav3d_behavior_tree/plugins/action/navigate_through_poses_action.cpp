...
#include "nav3d_behavior_tree/plugins/action/navigate_through_poses_action.hpp"
...
: BtActionNode<nav3d_msgs::action::NavigateThroughPoses>(xml_tag_name, action_name, conf)
{
}
...
BT_REGISTER_NODES(factory)
{
  BT::NodeBuilder builder =
    ...
    {
      return std::make_unique<nav3d_behavior_tree::NavigateThroughPosesAction>(
        name, "navigate_through_poses", config);
    };

  factory.registerBuilder<nav3d_behavior_tree::NavigateThroughPosesAction>(

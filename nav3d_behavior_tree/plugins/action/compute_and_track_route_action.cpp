...
#include "nav3d_behavior_tree/plugins/action/compute_and_track_route_action.hpp"
...
BT_REGISTER_NODES(factory)
{
  BT::NodeBuilder builder =
    ...
    {
      return std::make_unique<nav3d_behavior_tree::ComputeAndTrackRouteAction>(
        name, "compute_and_track_route", config);
    };

  factory.registerBuilder<nav3d_behavior_tree::ComputeAndTrackRouteAction>(
